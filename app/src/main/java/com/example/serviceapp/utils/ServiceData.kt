...
object ServiceData {
    ...
    val categories = listOf(
        // ── Electrician ─────────────────────────────────────────────────────────
        // normal = General+; advanced = Professional+; critical = Expert only
        ServiceCategory("electrician", "বিদ্যুৎ মিস্ত্রি", "Electrician", "⚡", listOf(
            ...
            ServiceProblem("সার্কিট ব্রেকার পড়ছে",    "Circuit breaker tripping",       problemType = "normal"),
            ServiceProblem("ভোল্টেজ সমস্যা",           "Voltage fluctuation",            problemType = "normal"),
            ServiceProblem("সুইচবোর্ড ইন্সটল",         "Switchboard install",            problemType = "normal"),
            ServiceProblem("লাইট/ফ্যান লাগানো",         "Light/fan installation",         problemType = "normal"),
            ServiceProblem("মিটার সমস্যা",              "Meter issue",                    problemType = "normal"),
            ServiceProblem("নতুন ওয়্যারিং",            "New wiring",                     problemType = "advanced"),
            ServiceProblem("শর্ট সার্কিট",             "Short circuit",                  problemType = "advanced"),
            ServiceProblem("পোড়া গন্ধ",               "Burning smell",                  problemType = "advanced"),
        ...
        ServiceCategory("plumbing", "প্লাম্বিং ও স্যানিটারি", "Plumbing & Sanitary", "🚰", listOf(
            ...
            ServiceProblem("পাইপ লিকেজ",               "Pipe leakage",                   problemType = "normal"),
            ServiceProblem("কমোড ইন্সটল",              "Commode installation",            problemType = "normal"),
            ServiceProblem("শাওয়ার সমস্যা",             "Shower problem",                 problemType = "normal"),
            ServiceProblem("পানির চাপ কম",              "Low water pressure",              problemType = "normal"),
            ServiceProblem("পাম্প কাজ করছে না",         "Pump not working",               problemType = "normal"),
            ServiceProblem("বাথরুম ফিটিং লাগানো",       "Bathroom fitting installation",  problemType = "normal"),
            ServiceProblem("ড্রেন বন্ধ",                "Drain blockage",                 problemType = "normal"),
        ...
        ServiceCategory("ac_fridge", "এসি / ফ্রিজ টেকনিশিয়ান", "AC / Fridge Technician", "❄️", listOf(
            ...
            ServiceProblem("এসি সার্ভিসিং",            "AC servicing",                   problemType = "normal"),
            ...
            ServiceProblem("বরফ জমছে না",              "Ice issue",                      problemType = "normal"),
            ServiceProblem("গ্যাস রিফিল",              "Gas refill",                     problemType = "advanced"),
            ServiceProblem("কম্প্রেসার সমস্যা",         "Compressor problem",              problemType = "advanced"),
            ServiceProblem("অন্যান্য",                 "Other",                          problemType = "normal"),
        )),
        // ── Electronics ───────────────────────────────────────────────────────
        ServiceCategory("electronics", "ইলেকট্রনিক্স ও যন্ত্রপাতি", "Electronics & Appliance", "📺", listOf(
            ...
            ServiceProblem("পাওয়ার সমস্যা",            "Power issue",                    problemType = "normal"),
            ServiceProblem("ডিসপ্লে সমস্যা",            "Display issue",                  problemType = "normal"),
        ...
        ServiceCategory("gas_stove", "গ্যাসের চুলা মিস্ত্রি", "Gas Stove Technician", "🔥", listOf(
            ...
            ServiceProblem("রেগুলেটর সমস্যা",           "Regulator issue",                problemType = "normal"),
            ServiceProblem("নতুন চুলা ইন্সটল",          "New stove installation",         problemType = "normal"),
        ...
        ServiceCategory("carpenter", "কাঠের কাজ", "Carpenter", "🪵", listOf(
            ...
            ServiceProblem("ক্যাবিনেট কাজ",             "Cabinet work",                   problemType = "normal"),
            ServiceProblem("নতুন ফার্নিচার",             "New furniture",                  problemType = "normal"),
            ServiceProblem("পার্টিশন তৈরি",             "Partition/divider work",         problemType = "normal"),
        ...
        ServiceCategory("painter", "রং ও পলিশ", "Painter / Polish", "🎨", listOf(
            ...
            ServiceProblem("ফাটল মেরামত ও রং",          "Crack repair & paint",           problemType = "normal"),
            ServiceProblem("পানির দাগ পরিষ্কার",         "Water stain removal",            problemType = "normal"),
            ServiceProblem("বাইরের দেয়ালে রং",          "Exterior wall painting",         problemType = "normal"),
            ServiceProblem("অন্যান্য",                 "Other",                          problemType = "normal"),
        )),
        // ── CCTV ──────────────────────────────────────────────────────────────
        ServiceCategory("cctv", "সিসিটিভি / নিরাপত্তা", "CCTV / Security", "📹", listOf(
            ...
            ServiceProblem("নতুন ক্যামেরা লাগানো",      "Camera installation",            problemType = "normal"),
            ServiceProblem("মোবাইলে দেখা যাচ্ছে না",    "Mobile app setup",               problemType = "normal"),
            ServiceProblem("ক্যাবল লাগানো",             "Cable installation",             problemType = "normal"),
            ServiceProblem("অন্যান্য",                 "Other",                          problemType = "normal"),
        )),
        // ── Internet / Network ────────────────────────────────────────────────
        ServiceCategory("internet", "ইন্টারনেট / নেটওয়ার্ক", "Internet / Network", "🌐", listOf(
            ...
            ServiceProblem("রাউটার সেটআপ",             "Router setup",                   problemType = "normal"),
            ServiceProblem("ক্যাবল সমস্যা",             "Cable issue",                    problemType = "normal"),
            ServiceProblem("নতুন সংযোগ লাগানো",          "New connection setup",           problemType = "normal"),
        ...
        ServiceCategory("mason", "রাজমিস্ত্রি / টাইলস", "Mason / Tiles", "🧱", listOf(
            ...
            ServiceProblem("নতুন টাইলস লাগানো",         "New tile installation",          problemType = "normal"),
            ServiceProblem("বাথরুম কাজ",               "Bathroom work",                  problemType = "normal"),
            ServiceProblem("সিমেন্ট কাজ",              "Cement work",                    problemType = "normal"),
            ServiceProblem("ছাদ থেকে পানি চুঁয়ানো",    "Roof leakage",                   problemType = "advanced"),
            ServiceProblem("অন্যান্য",                 "Other",                          problemType = "normal"),
        )),
        // ── Cleaning ──────────────────────────────────────────────────────────
        ServiceCategory("cleaning", "ক্লিনিং সার্ভিস", "Cleaning Service", "🧹", listOf(
            ...
            ServiceProblem("ডিপ ক্লিনিং",              "Deep cleaning",                  problemType = "normal"),
            ServiceProblem("এসি ফিল্টার পরিষ্কার",      "AC filter cleaning",             problemType = "normal"),
            ServiceProblem("নির্মাণ পরবর্তী পরিষ্কার",   "Post-construction cleaning",     problemType = "normal"),
            ServiceProblem("অন্যান্য",                 "Other",                          problemType = "normal"),
        )),
        // ── Laptop Servicing ──────────────────────────────────────────────────
        ServiceCategory("laptop", "ল্যাপটপ সার্ভিসিং", "Laptop Servicing", "💻", listOf(
            ServiceProblem("ল্যাপটপ চালু হচ্ছে না",      "Laptop not turning on",          problemType = "normal"),
            ServiceProblem("ধীরে চলছে",                "Running slow",                   problemType = "normal"),
            ServiceProblem("ব্যাটারি চার্জ হচ্ছে না",    "Battery not charging",           problemType = "normal"),
            ServiceProblem("ওভারহিটিং",                "Overheating",                    problemType = "normal"),
            ServiceProblem("স্ক্রিন সমস্যা",             "Screen issue",                   problemType = "normal"),
            ServiceProblem("কীবোর্ড কাজ করছে না",        "Keyboard not working",           problemType = "normal"),
            ServiceProblem("ভাইরাস / ম্যালওয়্যার",       "Virus / Malware",                problemType = "normal"),
            ServiceProblem("অপারেটিং সিস্টেম সমস্যা",    "OS issue / reinstall",           problemType = "normal"),
            ServiceProblem("হার্ডডিস্ক সমস্যা",           "Hard disk issue",                problemType = "normal"),
            ServiceProblem("র‍্যাম আপগ্রেড",              "RAM upgrade",                    problemType = "normal"),
            ServiceProblem("পানি পড়েছে",               "Water damage",                   problemType = "advanced"),
            ServiceProblem("অন্যান্য",                 "Other",                          problemType = "normal"),
        )),
        // ── Mobile Servicing ──────────────────────────────────────────────────
        ServiceCategory("mobile", "মোবাইল সার্ভিসিং", "Mobile Servicing", "📱", listOf(
            ServiceProblem("স্ক্রিন ভেঙেছে",             "Screen broken / cracked",        problemType = "normal"),
            ServiceProblem("চার্জ হচ্ছে না",            "Not charging",                   problemType = "normal"),
            ServiceProblem("ব্যাটারি দ্রুত শেষ হচ্ছে",   "Battery draining fast",          problemType = "normal"),
            ServiceProblem("ফোন গরম হচ্ছে",             "Phone overheating",              problemType = "normal"),
            ServiceProblem("ক্যামেরা কাজ করছে না",       "Camera not working",             problemType = "normal"),
            ServiceProblem("স্পিকার / মাইক সমস্যা",      "Speaker / mic issue",            problemType = "normal"),
            ServiceProblem("ধীরে চলছে / হ্যাং হচ্ছে",    "Slow / hanging",                 problemType = "normal"),
            ServiceProblem("ফিঙ্গারপ্রিন্ট কাজ করছে না",  "Fingerprint not working",        problemType = "normal"),
            ServiceProblem("নেটওয়ার্ক সমস্যা",            "Network issue",                  problemType = "normal"),
            ServiceProblem("মাদারবোর্ড সমস্যা",           "Motherboard issue",              problemType = "advanced"),
            ServiceProblem("পানি পড়েছে",               "Water damage",                   problemType = "advanced"),
            ServiceProblem("অন্যান্য",                 "Other",                          problemType = "normal"),
        )),
    )
