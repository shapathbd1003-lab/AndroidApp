...
object ServiceData {
    ...
    val categories = listOf(
        ...
        ServiceCategory("laptop", "ল্যাপটপ সার্ভিসিং", "Laptop Servicing", "💻", listOf(
            ...
            ServiceProblem("ভাইরাস / ম্যালওয়্যার",       "Virus / Malware",                problemType = "advanced"),
            ServiceProblem("অপারেটিং সিস্টেম সমস্যা",    "OS issue / reinstall",           problemType = "advanced"),
            ServiceProblem("হার্ডডিস্ক সমস্যা",           "Hard disk issue",                problemType = "advanced"),
            ServiceProblem("র‍্যাম আপগ্রেড",              "RAM upgrade",                    problemType = "advanced"),
            ServiceProblem("পানি পড়েছে",               "Water damage",                   problemType = "critical"),
            ServiceProblem("অন্যান্য",                 "Other",                          problemType = "normal"),
        )),
        ServiceCategory("mobile", "মোবাইল সার্ভিসিং", "Mobile Servicing", "📱", listOf(
            ...
            ServiceProblem("ফিঙ্গারপ্রিন্ট কাজ করছে না",  "Fingerprint not working",        problemType = "advanced"),
            ServiceProblem("নেটওয়ার্ক সমস্যা",            "Network issue",                  problemType = "advanced"),
            ServiceProblem("মাদারবোর্ড সমস্যা",           "Motherboard issue",              problemType = "critical"),
            ServiceProblem("পানি পড়েছে",               "Water damage",                   problemType = "critical"),
            ServiceProblem("অন্যান্য",                 "Other",                          problemType = "normal"),
        )),
    )
